...
print('The parameters are:', grid_rf.best_params_)

rf = RandomForestRegressor(max_depth = grid_rf.best_params_['max_depth'],n_estimators = grid_rf.best_params_['n_estimators'])
...
print('Mean Residuals is : ',residuals.mean())
