#This code is taken from Paul Wlodkowski's github repository
#(https://github.com/pawlodkowski/twitter-mongoDB/blob/master/twitter_streamer.py)
...
def get_tweet_dict(tweet):
    print('Collecting tweet dictionary')
...
class TwitterListener(StreamListener):
    ...
    def on_data(self, data):
        ...
        if 'RT' not in t['text'] and is_tweet_reply and is_quote:
            ...
            #Insert the whole thing into MongoDB
            db.Covid19.insert(tweet)
...
if __name__ == "__main__":
    while True:
        m = pymongo.MongoClient('mongodb')
        db = m.tweets
        twitter_streamer = TwitterStreamer(['Covid19'])
        twitter_streamer.stream_tweets(100)
        time.sleep(100)
